	...
	public static function optionsframework_machine($options) {
		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				//radiobox option
				case "radio":
					$checked = (isset($smof_data[$value['id']])) ? checked($smof_data[$value['id']], false, false) : '';
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup : ','framework').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
					$output .= '<a href="#" id="of_backup_button" class="button" title="'.__('Backup Options','framework').'">'.__('Backup Options','framework').'</a>';
					$output .= '<a href="#" id="of_restore_button" class="button" title="'.__('Restore Options','framework').'">'.__('Restore Options','framework').'</a>';
					$output .= '</div>';
